...
import calepinagePhysicalRouter from './routes/calepinage-physical'
...
elModule.route('/calepinage-physical', calepinagePhysicalRouter)  // Vue PHYSIQUE (disposition réelle)
