...
export function generateReportConformite(data: ReportDataConformite): string {
...
<head>
    ...
    <title>Rapport Conformité Électrique - ${project.name}</title>
    <style>
        @page {
            size: A4;
            margin: 15mm;
        ...
        <div class="info-box">
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span>Conformité Électrique (NF C 15-100)</span>
                </div>
            </div>
        </div>
