        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button onclick="copyICSRadioLink()" class="border border-purple-300 text-purple-700 bg-purple-50 hover:bg-purple-100 px-4 py-2 rounded-lg font-medium transition" title="Copier le lien d'abonnement Outlook">
