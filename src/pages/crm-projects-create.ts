    ...
    <script>
        ...
        document.getElementById('create-project-form').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success) {
                    if (data.warning) {
                         alert('Site créé avec succès (Mode Compatibilité).\\n\\nATTENTION: ' + data.message + '\\nLes données de configuration avancée ont été sauvegardées dans les notes car la base de données de production n\\'est pas à jour.');
                    } else {
